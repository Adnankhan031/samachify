  ...
  return (
    <main className="min-h-screen flex" style={{ background: 'var(--cream)' }}>
      ...
      <div className="hidden lg:flex lg:w-[45%] relative overflow-hidden">
        <img src="/assets/hero-all-products.webp" alt="" className="absolute inset-0 w-full h-full object-cover" />
        <div className="absolute inset-0" style={{ background: 'linear-gradient(150deg, rgba(11,22,6,0.82), rgba(42,79,7,0.7))' }} />
        <div className="relative z-10 flex flex-col justify-between p-12 text-white">
          ...
          <div>
            ...
            <h2 className="font-display font-black tracking-tight leading-tight mb-4" style={{ fontSize: '2.4rem' }}>
              Authentic South Indian meals, ready in minutes.
            </h2>
            <p className="text-white/70 max-w-md leading-relaxed">
              Sign in to track orders, save your favourites, and check out faster.
            </p>
          </div>
          <div className="text-white/50 text-sm">© {new Date().getFullYear()} Samachify. All rights reserved.</div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-5 py-10 sm:px-10">
        ...
        >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3.5 border border-gray-200 rounded-2xl font-700 text-gray-700 hover:bg-gray-50 hover:border-gray-300 transition-all mb-5"
          >
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <span className="text-xs font-600 text-gray-400">or</span>
            <div className="flex-1 h-px bg-gray-200" />
          </div>
