                ...
                >
                  ...
                  <div className="p-5 sm:p-6 flex flex-col flex-1">
                    ...
                    <div className="flex items-baseline gap-2 mb-4">
                      <span className="font-display font-800 text-gray-900 text-2xl">₹{product.price}</span>
                      <span className="text-xs font-600 text-gray-400">/ {product.servings}-person pack</span>
                    </div>
