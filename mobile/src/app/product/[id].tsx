...
const styles = StyleSheet.create({
  ...
  factLabel: { ...type.tiny, color: colors.muted, marginTop: 2 },
  ...
  ingredientNote: { ...type.tiny, fontWeight: '400', color: colors.faint, marginTop: 1 },
  ingredientAmount: { ...type.tiny, color: colors.leaf },
  ...
  stepNumberText: { fontSize: 12, fontWeight: '800', color: colors.leaf },
  ...
  nutrientLabel: { ...type.tiny, fontWeight: '400', color: colors.muted, marginTop: 2 },
  nutritionNote: { ...type.tiny, fontWeight: '400', color: colors.faint, marginTop: spacing.sm },

  highlight: { flexDirection: 'row', gap: spacing.md, paddingVertical: spacing.sm },
  tick: { color: colors.leaf, fontWeight: '800' },
  highlightText: { ...type.small, color: colors.ink80, flex: 1 },

  tradition: { marginTop: spacing.section, backgroundColor: colors.wash },
  traditionLabel: {
    ...type.tiny,
    color: colors.leaf,
  ...
  traditionText: { ...type.small, lineHeight: 21, color: colors.forest },
